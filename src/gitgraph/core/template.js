  ...
  constructor(options = {}) {
    ...
    this.branch = {
      ...
      label: {
        ...
        font: options.branch.label.font || options.commit.message.font || DEFAULT_FONT,
 ...
 * @param {string|Template} selectedTemplate Template to extend
 * @param {Object} options Template options
 * @returns {Template}
 */
export function templateExtend(selectedTemplate, options) {
 ...
 * @param {string|Template|undefined} template Selected template name, or instance.
 * @returns {Template}
 */
