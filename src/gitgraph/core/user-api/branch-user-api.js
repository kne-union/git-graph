...
export class BranchUserApi {
  ...
  _commitWithParents(options, parents) {
    ...
    // Extract render functions BEFORE any spreading
    ...
    const commitArgs = Object.assign(
      {
    ...
    // Force set render functions at the end to ensure they're not lost
    ...
    const commit = new Commit(commitArgs);
    if (parentOnSameBranch) {
  ...
  _getCommitStyle(style = {}) {
    return Object.assign({}, withoutUndefinedKeys(this._graph.template.commit), withoutUndefinedKeys(this._branch.commitDefaultOptions.style), style, {
      ...
      dot: Object.assign({}, withoutUndefinedKeys(this._graph.template.commit.dot), withoutUndefinedKeys(this._branch.commitDefaultOptions.style.dot), style.dot)
    });
  }
